...
export default function Footer() {
  ...
  return (
    <footer className="text-white bg-gradient-to-r from-indigo-700 via-indigo-400 to-indigo-700 pt-12 px-4 md:px-6">
            ...
            <ul className="space-y-4 text-sm md:text-base text-indigo-200">
              <li>
                <Link href="/services" className="hover:text-white transition-colors flex items-center gap-3 group">
                  <span className="w-1.5 h-1.5 rounded-full bg-indigo-500 group-hover:bg-white transition-colors shrink-0"></span> Computer AMC
                </Link>
              </li>
              <li>
                <Link href="/services" className="hover:text-white transition-colors flex items-center gap-3 group">
                  <span className="w-1.5 h-1.5 rounded-full bg-indigo-500 group-hover:bg-white transition-colors shrink-0"></span> Network Cabling
                </Link>
              </li>
              <li>
                <Link href="/services" className="hover:text-white transition-colors flex items-center gap-3 group">
                  <span className="w-1.5 h-1.5 rounded-full bg-indigo-500 group-hover:bg-white transition-colors shrink-0"></span> UPS Installation
                </Link>
              </li>
              <li>
                <Link href="/services" className="hover:text-white transition-colors flex items-center gap-3 group">
                  <span className="w-1.5 h-1.5 rounded-full bg-indigo-500 group-hover:bg-white transition-colors shrink-0"></span> CCTV Setup
                </Link>
              </li>
            </ul>
          </div>
            ...
            <ul className="space-y-4 text-sm md:text-base text-indigo-200">
              <li>
                <Link href="/about" className="hover:text-white transition-colors flex items-center gap-3 group">
                  <span className="w-1.5 h-1.5 rounded-full bg-indigo-500 group-hover:bg-white transition-colors shrink-0"></span> About Us
                </Link>
              </li>
              <li>
                <Link href="/products" className="hover:text-white transition-colors flex items-center gap-3 group">
                  <span className="w-1.5 h-1.5 rounded-full bg-indigo-500 group-hover:bg-white transition-colors shrink-0"></span> Products
                </Link>
              </li>
              <li>
                <Link href="/contact" className="hover:text-white transition-colors flex items-center gap-3 group">
                  <span className="w-1.5 h-1.5 rounded-full bg-indigo-500 group-hover:bg-white transition-colors shrink-0"></span> Contact
                </Link>
              </li>
            </ul>
          </div>
