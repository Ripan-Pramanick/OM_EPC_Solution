        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {expertiseCards.map((card, index) => (
            <motion.div
              ...
              className="group relative w-full h-[400px] md:h-[450px] rounded-t-[1.5rem] bg-white overflow-hidden shadow-[0_5px_15px_rgba(0,0,0,0.05)] border border-gray-100 flex flex-col cursor-pointer"
            >
