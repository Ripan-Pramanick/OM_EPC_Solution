      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16 md:mb-24">
          <motion.div 
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 text-[10px] font-bold text-[#111827] tracking-widest uppercase mb-6 px-4 py-1.5 border border-gray-200 rounded-full bg-white shadow-sm"
          >
        ...
        <div className="relative max-w-4xl mx-auto mb-20 md:mb-28">
          ...
          <motion.div 
            ...
            className="absolute top-1/2 -translate-y-1/2 -left-4 md:-left-24 w-[140px] h-[140px] md:w-[240px] md:h-[240px] bg-white rounded-full flex flex-col items-center justify-center shadow-[0_10px_40px_rgba(0,0,0,0.1)] p-4 md:p-8 text-center"
          >
          ...
          <motion.div 
            ...
            className="absolute top-1/2 -translate-y-1/2 -right-4 md:-right-24 w-[140px] h-[140px] md:w-[240px] md:h-[240px] bg-white rounded-full flex flex-col items-center justify-center shadow-[0_10px_40px_rgba(0,0,0,0.1)] p-4 md:p-8 text-center"
          >
            <Award size={28} className="text-[#111827] mb-2 md:mb-4" strokeWidth={1.5} />
            <span className="text-[7px] md:text-[10px] font-bold text-gray-500 tracking-widest uppercase mb-1 md:mb-2">TECH AWARDS</span>
            <span className="text-[10px] md:text-sm font-bold text-[#111827] leading-snug mb-1 md:mb-3">Trusted IT<br/>Infrastructure<br/>Firm</span>
