  ...
  return (
    ...
    <section className="relative bg-gradient-to-r from-indigo-700 via-indigo-400 to-indigo-50 min-h-[850px] lg:h-screen flex items-center overflow-hidden pt-32 pb-24 lg:py-40">
      ...
      <div className="max-w-[1400px] mx-auto w-full px-6 relative z-10 flex flex-col lg:flex-row items-center">
                ...
                return (
                  <div 
                    ...
                    className={`group flex items-center cursor-pointer transition-all duration-300 py-6 border-b ${
                      isActive ? 'border-white' : 'border-indigo-700/50 hover:border-indigo-500'
                    }`}
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <h4 className={`text-xl md:text-2xl transition-colors duration-300 ${
                        isActive ? 'font-bold text-white' : 'font-medium text-indigo-200 group-hover:text-white'
                      }`}>
                        {item.shortTitle}
                      </h4>
                    </div>
        ...
        */}
        <div className="hidden lg:flex absolute top-1/2 -translate-y-1/2 right-[45%] translate-x-1/2 z-30 w-[420px] h-[420px] xl:w-[480px] xl:h-[480px] bg-white rounded-full shadow-[0_30px_60px_rgba(0,0,0,0.3)] flex-col items-center justify-center p-12 text-center">
      ...
      <div className="lg:hidden relative w-full mt-16 px-6 z-20">
        <div className="relative w-full aspect-square max-w-[400px] mx-auto bg-white rounded-full shadow-2xl flex flex-col items-center justify-center p-8 text-center border-4 border-indigo-700">
          <AnimatePresence mode="wait">
            <motion.div
              key={activeIndex}
