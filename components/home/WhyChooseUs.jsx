...
export default function WhyChooseUs() {
  return (
    // Background updated to slate-50 to match the light theme in the image
      ...
      <div className="max-w-[1400px] mx-auto px-6 grid lg:grid-cols-[1fr_450px] xl:grid-cols-[1fr_500px] gap-12 lg:gap-16 items-center relative z-10">
        ...
        <div className="relative z-10">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl lg:text-[3.25rem] font-bold text-slate-900 leading-[1.1] mb-6 tracking-tight">
              Discover the Difference We Can Make
            </h2>

            <p className="text-slate-500 text-base md:text-lg mb-12 max-w-2xl leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            >
              ...
              <div className="relative w-16 h-16 shrink-0 flex items-center justify-center">
                <div className="absolute left-0 w-10 h-full bg-emerald-200/60 rounded-l-full"></div>
                <Award className="relative z-10 text-slate-900" size={28} strokeWidth={1.5} />
              </div>
              <div>
                <h4 className="text-xl font-bold text-slate-900 mb-2">Proven Expertise</h4>
                <p className="text-sm text-slate-500 mb-4 leading-relaxed">
                  Many years of hands-on experience in delivering successful IT and networking projects.
                </p>
                <Link href="#about" className="inline-flex items-center gap-2 text-sm font-bold text-slate-900 hover:text-emerald-600 transition-colors group">
            ...
            >
              <div className="relative w-16 h-16 shrink-0 flex items-center justify-center">
                <div className="absolute left-0 w-10 h-full bg-emerald-200/60 rounded-l-full"></div>
                <Lightbulb className="relative z-10 text-slate-900" size={28} strokeWidth={1.5} />
              </div>
              <div>
                ...
                <Link href="#services" className="inline-flex items-center gap-2 text-sm font-bold text-slate-900 hover:text-emerald-600 transition-colors group">
                  <ArrowRight size={16} className="transition-transform group-hover:translate-x-1" /> Read More
                </Link>
              </div>
            </motion.div>
          ...
          {/* Bottom: Dark 3-Column Card - Updated to Vibrant Indigo-600 */}
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ delay: 0.3 }}
            className="bg-emerald-700 rounded-[2rem] p-8 md:p-10 grid grid-cols-1 md:grid-cols-3 gap-8 shadow-2xl"
          >
            {/* Reason 01 */}
            <div>
              <UserCog className="text-emerald-50 mb-5" size={28} strokeWidth={1.5} />
              <p className="text-[10px] font-bold text-emerald-50 tracking-[0.2em] mb-2 uppercase">Reason 01</p>
              <h4 className="text-lg font-bold text-emerald-100 mb-3">Expert Technicians</h4>
            ...
            {/* Reason 02 */}
            <div>
              <Server className="text-emerald-50 mb-5" size={28} strokeWidth={1.5} />
              <p className="text-[10px] font-bold text-emerald-50 tracking-[0.2em] mb-2 uppercase">Reason 02</p>
              <h4 className="text-lg font-bold text-emerald-100 mb-3">Premium Hardware</h4>
              <p className="text-sm text-emerald-50 leading-relaxed">
            ...
            {/* Reason 03 */}
            <div>
              <Headset className="text-emerald-50 mb-5" size={28} strokeWidth={1.5} />
              <p className="text-[10px] font-bold text-emerald-50 tracking-[0.2em] mb-2 uppercase">Reason 03</p>
              <h4 className="text-lg font-bold text-emerald-100 mb-3">24/7 AMC Support</h4>
              <p className="text-sm text-emerald-50 leading-relaxed">
