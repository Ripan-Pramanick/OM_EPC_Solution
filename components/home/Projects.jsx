        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 xl:gap-10">
          {projects.map((project, index) => (
            <motion.div 
              ...
              className="group relative bg-white rounded-[2rem] overflow-hidden border border-gray-100 shadow-[0_4px_20px_rgba(0,0,0,0.02)] hover:shadow-[0_20px_50px_-15px_rgba(67,56,202,0.15)] hover:-translate-y-2 hover:border-indigo-100 transition-all duration-500 ease-out flex flex-col cursor-pointer"
            >
              
              {/* Image & Floating Category Badge */}
              <div className="relative w-full h-[280px] md:h-[320px] bg-[#F5F7FF] overflow-hidden">
                <div className="absolute top-6 left-6 z-10 bg-white/95 backdrop-blur-md px-4 py-1.5 rounded-full text-[10px] font-bold text-indigo-700 uppercase tracking-widest shadow-sm border border-gray-100">
                  {project.category}
                </div>
                <Image 
                  src={project.image} 
