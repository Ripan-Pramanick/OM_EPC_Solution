    ...
    <section id="about" className="py-24 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        >
          ...
          <div className="absolute top-[8%] right-0 w-[50%] bg-white rounded-2xl p-6 shadow-[0_20px_50px_-15px_rgba(0,0,0,0.1)] z-20 flex gap-4">
          ...
          <div className="absolute bottom-[5%] left-[5%] w-[45%] bg-[#36454F] rounded-2xl p-6 shadow-2xl z-30 flex items-center justify-between">
            ...
            <div className="w-12 h-12 rounded-full bg-white/10 border border-white/20 flex items-center justify-center text-white backdrop-blur-sm">
              <Target size={24} />
            </div>
          </div>
        </motion.div>
