        ...
        <div className="grid md:grid-cols-3 gap-8 xl:gap-10">
          {solutionFinders.map((item, index) => (
            <motion.div
              ...
              className="group relative bg-white rounded-[2.5rem] p-8 md:p-10 border border-gray-100 shadow-[0_4px_20px_rgba(0,0,0,0.02)] hover:shadow-[0_20px_50px_-15px_rgba(67,56,202,0.15)] hover:-translate-y-2 hover:border-indigo-100 transition-all duration-500 ease-out flex flex-col overflow-hidden z-10"
            >
