    ...
    <section className="pt-32 pb-16 md:pt-40 md:pb-24 bg-gradient-to-b from-[#EEF2FF]/60 to-white overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-6 grid xl:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        >
          ...
          <div className="absolute left-0 bottom-[10%] w-3/5 h-3/5 rounded-[2rem] bg-white overflow-hidden shadow-2xl z-20 border-4 border-white animate-[floating_8s_ease-in-out_infinite_reverse]">
            <Image src={productPageImages.hero.secondary} alt="Business IT" fill className="object-cover" />
          </div>

          <div className="absolute top-[20%] -left-8 bg-white/95 backdrop-blur-md p-5 rounded-2xl shadow-xl z-30 flex items-center gap-4 border border-indigo-50">
