                        ...
                        {productCategories.map((cat) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`flex flex-col items-center gap-3 min-w-[100px] p-4 rounded-2xl transition-all duration-300 ${isActive ? 'bg-indigo-700 text-white shadow-md' : 'bg-transparent text-[#64748B] hover:bg-[#F5F7FF] hover:text-[#111827]'
                                        }`}
                                >
