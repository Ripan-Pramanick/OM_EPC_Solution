...
export default function ContactMap() {
  ...
  return (
    ...
    <section id="map" className="py-16 md:py-24 px-4 md:px-6 bg-white">
      ...
      <div className="relative max-w-[1400px] mx-auto h-[500px] md:h-[600px] rounded-[2rem] md:rounded-[3rem] overflow-hidden shadow-2xl bg-gray-100 border border-gray-100/50">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none p-6">
          <motion.div 
            ...
            viewport={{ once: true }}
            className="bg-white/95 backdrop-blur-md rounded-2xl p-6 md:p-8 shadow-2xl border border-gray-100 max-w-sm w-full pointer-events-auto"
          >
