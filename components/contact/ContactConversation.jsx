    ...
    <section className="py-24 md:py-32 bg-gradient-to-r from-indigo-700 via-indigo-600 to-indigo-400 relative overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-6 grid lg:grid-cols-[1fr_450px] xl:grid-cols-[1.2fr_500px] gap-12 lg:gap-20 items-start relative z-10">
        ...
        <div className="flex flex-col h-full pt-4">
          ...
          >
            <Link href={contactData.social.facebook} className="w-10 h-10 rounded-full border border-indigo-400/30 flex items-center justify-center text-white hover:bg-white hover:text-indigo-700 transition-colors"><X size={14} /></Link>
            <Link href={contactData.social.facebook} className="w-10 h-10 rounded-full border border-indigo-400/30 flex items-center justify-center text-white hover:bg-white hover:text-indigo-700 transition-colors"><FacebookIcon size={16} /></Link>
            <Link href={contactData.social.instagram} className="w-10 h-10 rounded-full border border-indigo-400/30 flex items-center justify-center text-white hover:bg-white hover:text-indigo-700 transition-colors"><InstagramIcon size={16} /></Link>
            <Link href={contactData.social.youtube} className="w-10 h-10 rounded-full border border-indigo-400/30 flex items-center justify-center text-white hover:bg-white hover:text-indigo-700 transition-colors"><YouTubeIcon size={16} /></Link>
          </motion.div>
