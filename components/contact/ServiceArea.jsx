      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 md:mb-24">
          <motion.div 
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 text-[10px] font-bold text-indigo-700 tracking-widest uppercase mb-6 px-4 py-1.5 border border-indigo-100 rounded-full bg-white shadow-sm"
          >
        ...
        <div className="flex flex-col gap-6 max-w-5xl mx-auto">
          {contactData.locations.map((loc, index) => (
            <motion.div 
              ...
              className="group bg-white rounded-[2rem] border border-gray-200 overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-1 hover:border-indigo-200 transition-all duration-300 flex flex-col md:flex-row"
            >
              {/* Left Image */}
              <div className="relative w-full md:w-[350px] h-[250px] md:h-auto bg-gray-100 overflow-hidden shrink-0">
                ...
                <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm w-12 h-12 rounded-xl flex items-center justify-center font-bold text-indigo-700 shadow-sm">
                  HQ
                </div>
              </div>
