...
export default function AuthClient() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-[#F5F7FF] p-6 overflow-hidden relative">
      ...
      {/* Main Card Container */}
      <div className="relative w-full max-w-[1000px] h-[850px] md:h-[650px] bg-white border border-gray-100 rounded-[2rem] md:rounded-[3rem] shadow-[0_30px_60px_-15px_rgba(67,56,202,0.15)] overflow-hidden flex z-10">

        {/* LEFT PANEL: Register & OTP */}
        <div className={`absolute top-0 left-0 w-full md:w-1/2 h-full p-8 md:p-14 flex flex-col justify-center bg-white transition-all duration-700 ease-in-out z-20 ${isLogin ? 'opacity-0 pointer-events-none -translate-x-full md:translate-x-0' : 'opacity-100 pointer-events-auto translate-x-0 md:translate-x-[100%]'}`}>
            ...
            <>
              ...
              <form onSubmit={handleVerifyOtp} className="space-y-6">
                <div className="relative">
                  <span className="absolute -top-2.5 left-4 bg-white px-2 text-[11px] font-bold text-indigo-700 uppercase tracking-wider z-10">8-Digit OTP</span>
                  <div className="flex items-center border border-gray-200 hover:border-indigo-300 focus-within:border-indigo-600 rounded-xl px-4 py-3.5 bg-white transition-all">
              ...
              <form action={handleRegister} className="space-y-5">
                <div className="flex gap-4">
                  <div className="relative w-1/2">
                    <span className="absolute -top-2.5 left-4 bg-white px-2 text-[10px] font-bold text-indigo-700 uppercase tracking-wider z-10">First Name</span>
                    <div className="flex items-center border border-gray-200 hover:border-indigo-300 focus-within:border-indigo-600 rounded-xl px-4 py-3.5 bg-white transition-all shadow-sm">
                  ...
                  <div className="relative w-1/2">
                    <span className="absolute -top-2.5 left-4 bg-white px-2 text-[10px] font-bold text-indigo-700 uppercase tracking-wider z-10">Last Name</span>
                    <div className="flex items-center border border-gray-200 hover:border-indigo-300 focus-within:border-indigo-600 rounded-xl px-4 py-3.5 bg-white transition-all shadow-sm">
                ...
                <div className="relative">
                  <span className="absolute -top-2.5 left-4 bg-white px-2 text-[10px] font-bold text-indigo-700 uppercase tracking-wider z-10">Email Address</span>
                  <div className="flex items-center border border-gray-200 hover:border-indigo-300 focus-within:border-indigo-600 rounded-xl px-4 py-3.5 bg-white transition-all shadow-sm">
                ...
                <div className="relative">
                  <span className="absolute -top-2.5 left-4 bg-white px-2 text-[10px] font-bold text-indigo-700 uppercase tracking-wider z-10">Password</span>
                  <div className="flex items-center border border-gray-200 hover:border-indigo-300 focus-within:border-indigo-600 rounded-xl px-4 py-3.5 bg-white transition-all shadow-sm">
                    <Lock className="text-gray-400 mr-3 shrink-0" size={18} />
          ...
          <div className="relative w-full h-full overflow-hidden shadow-2xl">
            ...
            <div className={`absolute inset-0 flex flex-col items-center justify-center text-center p-12 text-white transition-opacity duration-500 ${isLogin ? 'opacity-100 delay-300' : 'opacity-0 pointer-events-none'}`}>
              ...
              <button
                ...
                className="border-2 border-white/50 hover:border-white rounded-xl px-12 py-3.5 font-bold text-[13px] hover:bg-white hover:text-indigo-700 transition-all uppercase tracking-widest shadow-lg cursor-pointer"
              >
                Create Account
              </button>
            </div>
